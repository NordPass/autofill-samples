...
export const MobileNavigation = () => {
  ...
  return (
    <nav className={`${toggleMenu ? 'block fixed h-full flex-wrap bg-base-100 overflow-auto' : ''}`}>
      <button
        ...
        {toggleMenu && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="inline-block w-8 h-8 stroke-current"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path></svg>}
      </button>
