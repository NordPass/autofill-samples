export const AllForms = () => (
  <div className="flex flex-wrap justify-around">
    <form className="flex text-center flex-col">
      ...
      <button className="btn btn-outline mt-3" type="submit">Sign In</button>
    </form>
    <form className="flex items-center flex-col">
      ...
      <button className="btn btn-outline mt-3" type="submit">Sign Up</button>
    </form>
    <form className="flex items-center flex-col">
      ...
      <button className="btn btn-outline mt-3" type="submit">Change Password</button>
    </form>
    <form className="flex items-center flex-col">
      ...
      <button className="btn btn-outline mt-3" type="submit">Get Password</button>
    </form>
    <form className="flex items-center flex-col">
      ...
      <button className="btn btn-outline mt-3" type="submit">Change Email</button>
    </form>
    <form className="flex items-center flex-col">
      ...
      <button className="btn btn-outline mt-3" type="submit">Submit Credit Card</button>
    </form>
    <form className="flex items-center flex-col">
      ...
      <button className="btn btn-outline mt-3" type="submit">Save</button>
    </form>
    <form className="flex items-center flex-col">
      ...
      <button className="btn btn-outline mt-3" type="submit">Search</button>
    </form>
    <form className="flex items-center flex-col">
      ...
      <button className="btn btn-outline mt-3" type="submit">Submit</button>
    </form>
    <form className="flex items-center flex-col">
    ...
    <form className="flex items-center flex-col">
      ...
      <input className="input input-bordered w-full max-w-xs" type="text" placeholder="Enter email" />
      <button className="btn btn-outline mt-3" type="submit">Login/Register</button>
    </form>
  </div>
);
